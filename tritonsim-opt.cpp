//===- tritonsim-opt.cpp - TritonSim Performance Model Tool ---------------===//
//
// This file implements the entry point for the TritonSim performance
...
int main(int argc, char **argv) {
  ...
  return asMainReturnCode(
      MlirOptMain(argc, argv, "TritonSim - Ascend NPU Performance Modeling Tool\n", registry));
}
