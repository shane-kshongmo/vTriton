...
CCE_KERNELS = [
    ...
    "vector_peak_transcendental_exp",
    "vector_peak_transcendental_log",
    "vector_peak_transcendental_sqrt",
    "vector_peak_transcendental_rsqrt",
    "vector_peak_transcendental_exp_fp32",
    "vector_peak_transcendental_log_fp32",
    "vector_peak_transcendental_sqrt_fp32",
    "vector_peak_transcendental_rsqrt_fp32",
    "scalar_peak",
    "mte_gm_to_ub",
    "mte_ub_to_gm",
    "mte_gm_to_l1",
